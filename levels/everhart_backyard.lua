...
function Level:load(player1, player2, canvas, draw_players, with_physics)
    ...
    if with_physics then
        ...
        self.Walls.left.shape = love.physics.newRectangleShape(20, 2*WindowHeight/GlobalScale)
        ...
        self.Walls.right.shape = love.physics.newRectangleShape(20, 2*WindowHeight/GlobalScale)
